...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //for round up switch
        SwitchCompat roundupSwitch = findViewById(R.id.switchRoundUp);
        roundupSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> calc_display_tip());

        //for feedback
        cost_of_serv = findViewById(R.id.editText);
    ...
    public void calc_display_tip(){
        boolean round_up_status = ((SwitchCompat)findViewById(R.id.switchRoundUp)).isChecked();
        TextView tip_tv = findViewById(R.id.tipResult);
